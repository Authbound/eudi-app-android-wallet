...
abstract class ScopedPresentationInteractorDelegate(
    ...
    protected val walletCorePresentationController: WalletCorePresentationController
        get() = scopedWalletCorePresentationController
            ?: getOrCreateKoinScope<WalletPresentationScope>(presentationScopeId)
                .get<WalletCorePresentationController>()
                .also {
                    scopedWalletCorePresentationController = it
                }
