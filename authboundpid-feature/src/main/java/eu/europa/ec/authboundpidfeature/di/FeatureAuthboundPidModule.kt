...
package eu.europa.ec.authboundpidfeature.di
...
@Module
@ComponentScan("eu.europa.ec.authboundpidfeature")
class FeatureAuthboundPidModule

@Factory
fun provideAuthboundPidIntroInteractor(
