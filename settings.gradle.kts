...
rootProject.name = "Authbound Wallet"
include(":app")
...
include(":wallet-activation-logic")
include(":notification-logic")
include(":quickid-logic")
include(":quickid-feature")
include(":authboundpid-logic")
include(":authboundpid-feature")
