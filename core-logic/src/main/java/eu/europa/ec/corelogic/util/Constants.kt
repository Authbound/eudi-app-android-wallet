...
object CoreActions {
    ...
    const val RE_ISSUANCE_WORK_REFRESH_FAILURE_STATUS_DETAILS_ACTION =
        "reissuance.refresh_failure_status_details.action"
    ...
    const val RE_ISSUANCE_FAILURE_STATUS_IDS_DETAILS_EXTRA =
        "reissuance.failure_status.ids_details.extra"
}
